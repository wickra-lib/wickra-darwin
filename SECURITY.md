...
Wickra Darwin is pre-1.0; only the latest release receives security
...
[GitHub Security Advisories](https://github.com/wickra-lib/wickra-darwin/security/advisories/new),
