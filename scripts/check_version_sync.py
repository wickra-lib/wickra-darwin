...
repository pins `wickra-darwin-core` from three manifests rather than one, ships the
...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pin", r'wickra-darwin-core = \{ version = "@V@", path = ', 1),
    # Two manifests pin wickra-darwin-core by path *and* version instead of through
    ...
    (
        ...
        "wickra-darwin-core pin",
        r'path = "\.\./\.\./crates/darwin-core", version = "@V@"',
        1,
    ),
    (
        "crates/darwin-bench/Cargo.toml",
        "wickra-darwin-core pin",
        r'path = "\.\./darwin-core", version = "@V@"',
        1,
    ),
    ...
    (
        "bindings/csharp/WickraDarwin/WickraDarwin.csproj",
        "NuGet version",
        r"<Version>@V@</Version>",
        1,
    ),
    ...
    ("examples/README.md", "sample output", r"wickra-darwin @V@", 1),
    ...
    (
        ...
        r'"name": "wickra-darwin",\s+"version": "@V@"',
        2,
    ),
]
