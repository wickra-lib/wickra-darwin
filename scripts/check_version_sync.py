...
repository pins `darwin-core` from three manifests rather than one, ships the
...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pin", r'darwin-core = \{ version = "@V@", path = ', 1),
    # Two manifests pin darwin-core by path *and* version instead of through
